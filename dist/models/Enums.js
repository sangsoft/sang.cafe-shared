...
exports.SUPPORTED_TAGS = Object.keys(TAGS_PREFIX).reduce((result, prefix) => {
    const places = Object.keys(TAGS_PLACES).reduce((output, place) => {
        ...
        return Object.assign(Object.assign({}, output), { [tagName]: text });
    }, {});
    return Object.assign(Object.assign({}, result), places);
}, {});
